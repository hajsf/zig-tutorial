...
pub extern fn joinStringsSize(firstname: [*c]const u8, lastname: [*c]const u8) u64;
pub extern fn joinStrings(buf_ptr: [*c]u8, buf_len: usize, firstname: [*c]const u8, lastname: [*c]const u8) u64;
